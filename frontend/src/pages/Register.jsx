    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold font-sans tracking-tight text-white">Criar Conta</h2>
          <p className="text-sm text-dark-muted mt-1 font-sans">Cadastre-se para começar a automatizar</p>
        </div>
